...
# Define the Google Gemini API key
API_KEY = os.getenv("API")

def get_url_response(image_path):
    """
    Parse the image for handwritten text, focusing on identifying usernames and their corresponding passwords. The output should be formatted in JSON with username as the key and password as the value. Ignore any irrelevant information or text outside the main content area.
    """
    ...
    # Define the prompt with a JSON schema for usernames and passwords
    prompt = """
...
def main():
    ...
    # Call the get_url_response function with the image path
